...
def example_attachment():
    ...
    tmp = tempfile.NamedTemporaryFile(
        suffix=".txt", mode="w", delete=False, prefix="router_config_"
    )
...
EXAMPLES = {
    ...
    "attach": example_attachment,
    "attach_image": example_image_attachment,
    "attach_url": example_url_attachment,
}
